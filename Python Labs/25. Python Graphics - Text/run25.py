...
color = 255
window.getMouse();
clicko = Text(Point(650,70),"You clicked once to move the Sun!")
clicko.draw(window)
clicko.setStyle("bold")
clicko.setSize(20)
clicko.setTextColor("cyan")
...
clicko.undraw()
while(counter<10):
    clickt = Text(Point(650,70),counter)
    clickt.draw(window)
    clickt.setStyle("bold")
    clickt.setSize(20)
    clickt.setTextColor("red")
    clickth = Text(Point(780,70),": times clicked")
    clickth.draw(window)
    clickth.setStyle("bold")
    clickth.setSize(20)
    clickth.setTextColor("red")
    rx = randint(-100,100)
    ry = randint(-30,30)
    window.getMouse()
    wow.move(rx,ry)
    ...
    if counter ==10:
        ...
        clickt.undraw()
wow.undraw()
newpoint = wow.getAnchor()
rewow = Image(newpoint,"recolorwaldo.gif")
rewow.draw(window)
newcounter = 0
while(5>3):
    clickt = Text(Point(650,70),newcounter)
    clickt.draw(window)
    clickt.setStyle("bold")
    clickt.setSize(20)
    clickt.setTextColor("yellow")
    clickth.setTextColor("yellow")
