...
main()
{
  ...
  // write code here
	...
	cin>>sam;
	cout<<endl<<"Please enter h (if you want it to be horizantal) or v if you want your it to be vertical, or d if you want it to be diagonal: ";
	cin>>dylan;
	cout<<endl;
	if(dylan == 'h')
	{
